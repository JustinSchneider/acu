...
function wpmem_inc_status()
{
	...
	//$status = '<p>' . sprintf( __( 'You are logged in as %s', 'wp-members' ), $user_login )	. ' | <a href="' . $logout . '">' . __( 'click here to logout', 'wp-members' ) . '</a></p>';
	$status = '<p class="navbar-text navbar-right"><a href="' . $logout . '">Sign out</a></p><p class="navbar-text navbar-right"><a href="/profile">Profile</a></p>';
	...
	if( ! is_user_logged_in() ){
		...
		if( WPMEM_OLD_FORMS == 1 ) {
			...
			$str.= '<ul class="nav navbar-nav navbar-right">
				<li>
					<form class="navbar-form" role="form" name="form" method="post" action="' . $post_to . '">
						<div class="form-group">
							<input type="text" name="log" id="username" placeholder="Username" class="form-control">
						</div>
						<div class="form-group">
			...
			if( WPMEM_REGURL != null ) {
				...
				$str.= '<li><a href="' . $link . '">' . __( 'Register', 'wp-members' ) . '</a></li>';
			}
			 		
			if( WPMEM_MSURL != null ) { 
				$link = apply_filters( 'wpmem_forgot_link', wpmem_chk_qstr( WPMEM_MSURL ) . 'a=pwdreset' );	
				$str.= '<li><a href="' . $link . '">' . __( 'Forgot?', 'wp-members' ) . '</a></li>';
			}
...
//		  <a href="' . $logout . '">' . __( 'click here to logout', 'wp-members' ) . '</a></p>';
		...
		$str = '<p class="navbar-text navbar-right"><a href="' . $logout . '">Sign out</a></p><p class="navbar-text navbar-right"><a href="/profile">Profile</a></p>';
